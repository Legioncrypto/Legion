...
const string strMessageMagic = "Legion Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1){
      ...
      nSubsidy = 500000 * COIN;
    } else if (nHeight > 11 && nHeight <= 25000){
      nSubsidy = 5 * COIN;
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 4000 && nBestHeight <= 30000){
      nSubsidy = 10 * COIN;
    } else if(nBestHeight > 30000 && nBestHeight < 50000){
      nSubsidy = 20 * COIN;
    } else if(nBestHeight >= 50000 && nBestHeight < 100000){
      nSubsidy = 30 * COIN;
    } else if(nBestHeight >= 100000 && nBestHeight < 200000){
      nSubsidy = 50 * COIN;
    } else if(nBestHeight >= 200000 && nBestHeight < 300000){
      nSubsidy = 30 * COIN;
    } else if(nBestHeight >= 300000 && nBestHeight < 500000){
      nSubsidy = 50 * COIN;
    } else if(nBestHeight >= 500000 && nBestHeight < 10000000){
      nSubsidy = 20 * COIN;
    } else{
      nSubsidy = 20 * COIN;
    }
