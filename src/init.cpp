...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: Legion.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: legiond.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizelegionamount=<n> " + _("Keep N Legion anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Legion is probably already running."), strDataDir));
    ...
    nAnonymizeLegionAmount = GetArg("-anonymizelegionamount", 0);
    if(nAnonymizeLegionAmount > 999999) nAnonymizeLegionAmount = 999999;
    if(nAnonymizeLegionAmount < 2) nAnonymizeLegionAmount = 2;
    ...
    LogPrintf("Anonymize Legion Amount %d\n", nAnonymizeLegionAmount);
